...
using OpenGLDotNet.Render.Camera2D;
using System;
...
namespace OpenGLDotNet
{
    class Game1 : Game
    {
        ...
        public Game1(int initialWindowWidth, int initialWindowHeight, string initialWindowTitle) : base(initialWindowWidth, initialWindowHeight, initialWindowTitle)
        {
        ...
        protected unsafe override void LoadContent()
        {
            ...
            float[] vertices =
            {
                ...
                0.5f, 0.5f, 1f, 1f, 0f, //Top Right, Yellow
                -0.5f, -0.5f, 0f, 0f, 1f, //Bottom Left, Blue
                //Right Triangle
                0.5f, 0.5f, 1.0f, 1f, 0f, //Top Right, Yellow
                0.5f, -0.5f, 0f, 1f, 0f, //Bottom Right, Green
                -0.5f, -0.5f, 0f, 0f, 1f, //Bottom Left, Blue
            };
            ...
            camera = new Camera2D(DisplayManager.WindowSize / 2.0f, 2.5f);
        }
